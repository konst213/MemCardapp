...
from random import shuffle                               # Для перемішування варіантів відповідей
...
questions_list.append( Question("Hallo!", "Hallo, wie geht's?", "Tschüss!", "Ich wohne in Kyiv.", "Hast du eine Eule?"))
questions_list.append( Question("What is you name?", "I am...", "Hello school is here", "Man is strong", "I am a karate master!"))
...
def next_question():                # Збільшуємо індекс питання
    window.total += 1
    print(f"Questions, {window.total} and points {window.score}")
